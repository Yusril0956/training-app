...
<?php endif; ?>
    ...
    <span class="nav-link d-flex lh-1 text-reset p-0">
        <span
            ...
            style="background-image: url(<?php echo e(Session::get('user')->photo_url); ?>)"
        >
        </span>
        <div class="d-none d-xl-block ps-2">
            <div><?php echo e(ucwords(strtolower(Auth::user()->name))); ?></div>
...
<?php endif; ?>
<?php /**PATH /home/msi/Documents/templates/resources/views/components/partials/userbox.blade.php ENDPATH**/ ?>