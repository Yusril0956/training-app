      ...
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./static/logo.jpg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./static/avatars/star.jpg)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div>Refan Al-Kholqi</div>
                  <div class="mt-1 small text-secondary">Siswa PKL</div>
                </div>
              </a>
            ...
            <div class="row row-deck row-cards">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-secondary" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">7 Hari Terakhir</a>
                    ...
                    <div class="d-flex mb-2">
                      ...
                      <div class="ms-auto">
                        <span class="text-green d-inline-flex align-items-center lh-1">
                          75% <!-- Download SVG icon from http://tabler-icons.io/i/trending-up -->
                    ...
                    <div class="progress progress-sm">
                      <div class="progress-bar bg-primary" style="width: 75%" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" aria-label="75% Complete">
                        <span class="visually-hidden">75% Berhasil</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">User Aktif</div>
                      <div class="ms-auto lh-1">
                        <div class="dropdown">
                          <a class="dropdown-toggle text-secondary" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">7 Hari Terakhir</a>
                          <div class="dropdown-menu dropdown-menu-end">
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">Ringkasan grafik</h3>
              ...
              <div class="col-lg-6">
                <div class="row row-cards">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <p class="mb-3">Menggunakan Penyimpanan <strong>6854.45 MB </strong>Dari 8 GB</p>
                      ...
                      <div class="card-body card-body-scrollable card-body-scrollable-shadow">
                        <div class="divide-y">
                          <div>
                            <div class="row">
                              ...
                              <div class="col">
                                ...
                                <div class="text-secondary">kemarin</div>
                              </div>
                          ...
                          <div>
                            <div class="row">
                              <div class="col-auto">
                                <span class="avatar" style="background-image: url(./static/avatars/pp.jpg)"></span>
                              </div>
                              <div class="col">
                                <div class="text-truncate">
                                  ini akun <strong>Refan</strong>. Entah ngapain saya di sini
                                </div>
                                <div class="text-secondary">2 hari yang lalu</div>
                              </div>
                              <div class="col-auto align-self-center">
                                <div class="badge bg-primary"></div>
                              </div>
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-header border-0">
                    <div class="card-title">Kegiatan Development</div>
                  </div>
                  <div class="position-relative">
                    <div class="position-absolute top-0 left-0 px-3 mt-1 w-75">
                      <div class="row g-2">
                        ...
                        <div class="col">
                          <div>Penghasilan sekarang: Rp 10.000</div>
                          <div class="text-secondary"><!-- Download SVG icon from http://tabler-icons.io/i/trending-up -->
                            ...
                            +1% Lebih besar dari sebelumnya</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                      <div class="col-10">
                        ...
                        <div class="markdown text-secondary">
                          Semua ikon berasal dari set Ikon Tabler dan berlisensi MIT. Kunjungi
                          <a href="https://tabler-icons.io" target="_blank" rel="noopener">tabler-icons.io</a>,
                          unduh salah satu dari 637 ikon dalam SVG, PNG atau 4&nbsp;React dan gunakan di alat desain favorit Anda.
                        </div>
                        <div class="mt-3">
...
</html><?php /**PATH C:\xampp\htdocs\templates\resources\views/depan/index.blade.php ENDPATH**/ ?>